...
@icssbot.on(admin_cmd(pattern="ttf ?(.*)"))
@icssbot.on(sudo_cmd(pattern="ttf ?(.*)", allow_sudo=True))
async def get(event):
    name = event.text[5:]
    if name is None:
...
@icssbot.on(admin_cmd(pattern="ftoi$"))
@icssbot.on(sudo_cmd(pattern="ftoi$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="متحركه(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="متحركه(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="nfc ?(.*)"))
@icssbot.on(sudo_cmd(pattern="nfc ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
