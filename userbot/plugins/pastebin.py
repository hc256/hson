...
@icssbot.on(admin_cmd(pattern="paste(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="paste(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="neko(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="neko(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="iffuci(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="iffuci(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    catevent = await edit_or_reply(event, "`pasting to del dog.....`")
...
@icssbot.on(admin_cmd(pattern="pcode(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="pcode(?: |$)(.*)"))
...
@icssbot.on(admin_cmd(pattern="paster(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="paster(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    catevent = await edit_or_reply(event, "`pasting to del dog.....`")
