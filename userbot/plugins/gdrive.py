...
@icssbot.on(admin_cmd(pattern="gauth$", command="gauth", outgoing=True))
@icssbot.on(sudo_cmd(pattern="gauth$", command="gauth", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="greset$", command="greset", outgoing=True))
@icssbot.on(sudo_cmd(pattern="greset$", command="greset", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="gabort$", command="gabort", outgoing=True))
@icssbot.on(sudo_cmd(pattern="gabort$", command="gabort", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="ugd(?: |$)(.*)", command="ugd", outgoing=True))
@icssbot.on(sudo_cmd(pattern="ugd(?: |$)(.*)", command="ugd", allow_sudo=True))
async def google_drive(gdrive):
    ...
    if service is False:
        return None
    gdrive = await eor(gdrive, "**^ جاري التحميل**")
...
@icssbot.on(admin_cmd(pattern="gshare (.*)", command="gshare"))
@icssbot.on(sudo_cmd(pattern="gshare (.*)", command="gshare", allow_sudo=True))
