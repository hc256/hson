...
@icssbot.on(admin_cmd(pattern="push$"))
@icssbot.on(sudo_cmd(pattern="push$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = "`.      😎\n          |\👐\n         / \\\n━━━━━┓ ＼＼ \n┓┓┓┓┓┃\n┓┓┓┓┓┃ ヽ😩ノ\n┓┓┓┓┓┃ 　 /　\n┓┓┓┓┓┃  ノ)　 \n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃\n┓┓┓┓┓┃`"
...
@icssbot.on(admin_cmd(pattern="work$"))
@icssbot.on(sudo_cmd(pattern="work$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = "`📔📚             📚\n📓📚📖  😫  📚📚📓\n📕📚📚  📝  📗💻📘\n📖⁣📖📖📖📖📖📖📖📖`"
...
@icssbot.on(admin_cmd(pattern=r"lmoon$"))
@icssbot.on(sudo_cmd(pattern="lmoon$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern=r"city$"))
@icssbot.on(sudo_cmd(pattern="city$", allow_sudo=True))
async def test(event):
    if event.fwd_from:
        return
    await edit_or_reply(
