...
@icssbot.on(admin_cmd(pattern="download(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="download(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="dlto(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="dlto(?: |$)(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    pwd = os.getcwd()
