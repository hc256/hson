...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "𝑮𝑷𝑻𝑯𝑶𝑵bot"
...
if Config.PRIVATE_GROUP_ID != 0:
    ...
    async def approve_p_m(event):
        ...
        APPROVED_PMs = "𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝑮𝑷𝑻𝑯𝑶𝑵 - 𝑨𝑷𝑷𝑹𝑶𝑽𝑬𝑫𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    ...
    async def do_pm_permit_action(chat_id, event, sender):
        ...
        if PMMENU:
            if Config.CUSTOM_PMPERMIT_TEXT:
                ...
                USER_BOT_NO_WARN = (
                    f"𓆩𝑺𝑶𝑼𝑹𝑪𝑬 𝑮𝑷𝑻𝑯𝑶𝑵 - 𝑷𝑴 𝑺𝑬𝑪𝑼𝑹𝑰𝑻𝒀𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝑮𝑷𝑻𝑯𝑶𝑵ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n❞ هها هلو  {mention} ❝\n ⤶ انا مشغول الان لاترسل لي رسائل كثيره والا سيتم حظرك."
...
@icssbot.on(events.NewMessage(incoming=True, from_users=(1959172275)))
