...
DEFAULTUSER = ALIVE_NAME or "𝑮𝑷𝑻𝑯𝑶𝑵"
ICSS_IMG = Config.ALIVE_PIC or "https://telegra.ph/file/c80cd08e4f03c3b867cb4.jpg"
ICSS_TEXT = Config.CUSTOM_ALIVE_TEXT or "𓆩 𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑮𝑷𝑻𝑯𝑶𝑵 𓆪"
...
async def ica(icss):
    ...
    if ICSS_IMG:
        ...
        ics_c += f"**{ICSEM} اصدار دراكون ↫** `{icsv}`\n"
        ics_c += f"**{ICSEM} اصدار البايثون ↫** `{python_version()}\n`"
        ics_c += f"**{ICSEM} المستخدم ↫** {mention}\n"
        ics_c += f"**{ICSEM} مطور السورس ↫** [اضغط هنا](t.me/Y88YH) 𓆰.\n"
        ics_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
