...
@icssbot.on(admin_cmd(pattern="ls ?(.*)", command="ls"))
@icssbot.on(sudo_cmd(pattern="ls ?(.*)", allow_sudo=True, command="ls"))
async def lst(event):
...
@icssbot.on(admin_cmd(pattern="rem (.*)", command="rem"))
@icssbot.on(sudo_cmd(pattern="rem (.*)", command="rem", allow_sudo=True))
async def lst(event):
...
@icssbot.on(admin_cmd(pattern="mkdir(?: |$)(.*)", outgoing=True, command="mkdir"))
@icssbot.on(sudo_cmd(pattern="mkdir(?: |$)(.*)", allow_sudo=True, command="mkdir"))
async def _(event):
    if event.fwd_from:
        return
    pwd = os.getcwd()
...
@icssbot.on(admin_cmd(pattern="cpto(?: |$)(.*)", outgoing=True, command="cpto"))
@icssbot.on(sudo_cmd(pattern="cpto(?: |$)(.*)", allow_sudo=True, command="cpto"))
async def _(event):
    if event.fwd_from:
        return
    pwd = os.getcwd()
...
@icssbot.on(admin_cmd(pattern="mvto(?: |$)(.*)", outgoing=True, command="mvto"))
@icssbot.on(sudo_cmd(pattern="mvto(?: |$)(.*)", allow_sudo=True, command="mvto"))
async def _(event):
    if event.fwd_from:
        return
    pwd = os.getcwd()
