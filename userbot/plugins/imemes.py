...
@icssbot.on(admin_cmd(outgoing=True, pattern="fakegs(?: |$)(.*)", command="fakegs"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="fakegs(?: |$)(.*)", command="fakegs"))
...
@icssbot.on(admin_cmd(outgoing=True, pattern="trump(?: |$)(.*)", command="trump"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="trump(?: |$)(.*)", command="trump"))
async def nekobot(cat):
    if cat.fwd_from:
        return
    text = cat.pattern_match.group(1)
...
@icssbot.on(admin_cmd(outgoing=True, pattern="modi(?: |$)(.*)", command="modi"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="modi(?: |$)(.*)", command="modi"))
async def nekobot(cat):
    if cat.fwd_from:
        return
    text = cat.pattern_match.group(1)
...
@icssbot.on(admin_cmd(outgoing=True, pattern="cmm(?: |$)(.*)", command="cmm"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="cmm(?: |$)(.*)", command="cmm"))
async def nekobot(cat):
    if cat.fwd_from:
        return
    text = cat.pattern_match.group(1)
...
@icssbot.on(admin_cmd(outgoing=True, pattern="kanna(?: |$)(.*)", command="kanna"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="kanna(?: |$)(.*)", command="kanna"))
async def nekobot(cat):
    if cat.fwd_from:
        return
    text = cat.pattern_match.group(1)
...
@icssbot.on(admin_cmd(outgoing=True, pattern="tweet(?: |$)(.*)", command="tweet"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="tweet(?: |$)(.*)", command="tweet"))
async def nekobot(cat):
    if cat.fwd_from:
        return
    text = cat.pattern_match.group(1)
