...
@icssbot.on(admin_cmd(pattern=r"sing$", outgoing=True))
@icssbot.on(sudo_cmd(pattern=r"sing$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern=f"hps$", outgoing=True))
@icssbot.on(sudo_cmd(pattern=f"hps$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern=f"gott$", outgoing=True))
@icssbot.on(sudo_cmd(pattern=f"gott$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    if x == 24:
        await event.edit(
            '`"I am the \'s daughter, and I swear to you that those who would harm you will die screaming."`'
        )
    if x == 25:
        await event.edit(
...
@icssbot.on(admin_cmd(pattern=f"gotm$", outgoing=True))
@icssbot.on(sudo_cmd(pattern=f"gotm$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="bello$", outgoing=True))
@icssbot.on(sudo_cmd(pattern="bello$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    event = await edit_or_reply(event, "Typing....")
...
@icssbot.on(admin_cmd(pattern=r"tip$", outgoing=True))
@icssbot.on(sudo_cmd(pattern=r"tip$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern=r"qt$"))
@icssbot.on(sudo_cmd(pattern=r"qt$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern=f"logic$", outgoing=True))
@icssbot.on(sudo_cmd(pattern=f"logic$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
