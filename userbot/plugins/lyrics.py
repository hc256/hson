...
@icssbot.on(admin_cmd(outgoing=True, pattern="lyrics ?(.*)"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="lyrics ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(outgoing=True, pattern="glyrics ?(.*)"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="glyrics ?(.*)"))
