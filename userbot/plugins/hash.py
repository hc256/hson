...
@icssbot.on(admin_cmd(outgoing=True, pattern="hash (.*)"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="hash (.*)"))
@errors_handler
...
@icssbot.on(admin_cmd(outgoing=True, pattern="hbase (en|de) ?(.*)"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="hbase (en|de) ?(.*)"))
@errors_handler
