...
async def carbon_api(e):
    ...
    await e.client.send_file(
        e.chat_id,
        file,
        caption="**⌔∮ هذا هو الكاربون الخاص بك,** \n **تم انشاء هذا الكاربون بواسطه 𝑮𝑷𝑻𝑯𝑶𝑵. **",
        force_document=True,
...
@icssbot.on(admin_cmd(outgoing=True, pattern="krb"))
@icssbot.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
...
@icssbot.on(admin_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
...
@icssbot.on(admin_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="kar2(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
    cat = await edit_or_reply(e, "📛📛📛📛📛")
...
@icssbot.on(admin_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="kar3(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
    cat = await edit_or_reply(e, "🎛🎛🎛🎛🎛")
...
@icssbot.on(admin_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="kar4(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
    cat = await edit_or_reply(e, "🌚🌚🌚🌚🌚")
...
@icssbot.on(admin_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="rgbk2(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
...
@icssbot.on(admin_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="kargb(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    RED = random.randint(0, 256)
    GREEN = random.randint(0, 256)
    BLUE = random.randint(0, 256)
