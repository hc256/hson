...
# for print :
usr = "𝑮𝑷𝑻𝑯𝑶𝑵 USERBOT -{}".format(Tlk)
adn = "𝑮𝑷𝑻𝑯𝑶𝑵 ADMIN TOOLS -{}".format(Tlk)
ani = "𝑮𝑷𝑻𝑯𝑶𝑵 ANIMATIONS -{}".format(Tlk)
tsh = "𝑮𝑷𝑻𝑯𝑶𝑵 TOSHA -{}".format(Tlk)
ast = "𝑮𝑷𝑻𝑯𝑶𝑵 ASSISTANT -{}".format(Tlk)
pmt = "𝑮𝑷𝑻𝑯𝑶𝑵 ASSISTANT PM -{}".format(Tlk)
